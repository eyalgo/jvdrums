...
public class StandardDialog extends JDialog {
    ...
    private void init() {
        ...
        contentPane.getActionMap().put(cancel, (Action) cancel);
        setContentPane(contentPane);
        descriptionLabel.setBackground(Color.white);
        descriptionLabel.setBorder(new CompoundBorder(new RuleBorder(RuleBorder.BOTTOM),
    ...
    /**
     * Add an action and optionally set its button as the default button of this dialog.
     * 
     * @param action
     *            action to add
     * @param isDefault
    ...
    /**
     * Guarantee that the size of this dialog is greater than the preferred size.
     */
